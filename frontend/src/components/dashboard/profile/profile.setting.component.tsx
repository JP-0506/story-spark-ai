...
export const ProfileSettingComponent = ({
  ...
  const inputClassName =
    "w-full px-4 py-2 border border-slate-350 rounded-lg bg-white text-slate-950 dark:bg-slate-900/70 dark:text-gray-100 dark:border-slate-700/50 disabled:text-slate-600 placeholder:text-slate-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition";
